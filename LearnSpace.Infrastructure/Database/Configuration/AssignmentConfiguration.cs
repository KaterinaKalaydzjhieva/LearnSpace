    ...
    public class AssignmentConfiguration : IEntityTypeConfiguration<Assignment>
    {
        ...
        private static List<Assignment> SeedAssignments() 
        {
            ...
            { 
                ...
                DueDate = DateTime.Parse("12/25/2024"),
                CourseId = 1,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/10/2024"),
                CourseId = 1,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/26/2024"),
                CourseId = 2,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/09/2024"),
                CourseId = 2,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/27/2024"),
                CourseId = 3,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/28/2024"),
                CourseId = 4,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/06/2024"),
                CourseId = 4,
            };
            ...
            assignment = new Assignment()
            {
                ...
                DueDate = DateTime.Parse("12/14/2024"),
                CourseId = 5,
            };
